...
This project uses an Arduino Mega, a cheap ELM327 OBD-II adapter and a 4D Systems display.
You can change the code to add a software serial if you want to not use a mega.

I modified the ELM adapter to have a power switch, and a Ford HS / MS Can switch.
Here is a link to the MScan switch guide.
http://forscan.org/forum/viewtopic.php?f=4&t=4

I modified a bluetooth ELM adapter I had. I removed the BlueTooth module and tapped into the 
